...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/castleUI/NewSCv2/main/core/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/castleUI/NewSCv2/main/setup/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/castleUI/NewSCv2/main/add/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/castleUI/NewSCv2/main/delssr/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/castleUI/NewSCv2/main/renew/renewssr.sh && chmod +x /usr/bin/renewssr
